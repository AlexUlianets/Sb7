                ...
                <ul class="nav" ui-nav>
                    ...
                    <li>
                        <a href="{{ route('adminHome') }}" onclick="location.href='{{ route('adminHome') }}'">
                            ...
                            <?php
                            $currentFolder1 = "lists"; // Put folder name here
                            $PathCurrentFolder1 = substr($urlAfterRoot, 0, strlen($currentFolder1));

                            $currentFolder2 = "listsLayout"; // Put folder name here
                            $PathCurrentFolder2 = substr($urlAfterRoot, 0, strlen($currentFolder2));

                            $currentFolder3 = "listsPremium"; // Put folder name here
                            $PathCurrentFolder3 = substr($urlAfterRoot, 0, strlen($currentFolder3));
                            ?>
                    <li {{ ($PathCurrentFolder1==$currentFolder1 || $PathCurrentFolder2==$currentFolder2 || $PathCurrentFolder3==$currentFolder3 ) ? 'class=active' : '' }}>
                        <a>
                            ...
                            <ul class="nav-sub">
                                ...
                                <li {{ ($PathCurrentFolder1==$currentFolder1) ? 'class=active' : '' }}>
                                    <a href="{{ route('lists') }}"
                                       onclick="location.href='{{ route('lists') }}'">
                                ...
                                $PathCurrentFolder2 = substr($urlAfterRoot, 0, strlen($currentFolder2));
                                ?>
                                <li {{ ($PathCurrentFolder2==$currentFolder2) ? 'class=active' : '' }}>
                                    <a href="{{ route('listsLayout') }}">
                                        <span class="nav-text">{{ trans('backLang.listsLayout') }}</span>
                                    </a>
                                </li>
                                <?php
                                $currentFolder3 = "listsPremium"; // Put folder name here
                                $PathCurrentFolder3 = substr($urlAfterRoot, 0, strlen($currentFolder3));
                                ?>
                                <li {{ ($PathCurrentFolder3==$currentFolder3) ? 'class=active' : '' }}>
                                    <a href="{{ route('listsPremium') }}">
                                        <span class="nav-text">{{ trans('backLang.listsPremium') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </a>
