...
Route::Group(['prefix' => env('BACKEND_PATH')], function () {
    ...
    // Route::post('/lists', 'listsController@edit')->name('listsEdit');
    Route::post('/lists/store', 'listsController@store')->name('listsStore');

    Route::get('/lists/layout', 'listsLayoutController@index')->name('listsLayout');
    Route::get('/lists/premium', 'listsPremiumController@index')->name('listsPremium');

    // Route::get('/updateCustomSetting', 'updateCustomSettingController@edit')->name('lists');
    ...
    // Contacts Groups
    Route::post('/members/storeGroup', 'ContactsController@storeGroup')->name('contactsStoreGroup');
    Route::get('/members/{id}/editGroup', 'ContactsController@editGroup')->name('contactsEditGroup');
    Route::post('/members/{id}/updateGroup', 'ContactsController@updateGroup')->name('contactsUpdateGroup');
    Route::get('/members/destroyGroup/{id}', 'ContactsController@destroyGroup')->name('contactsDestroyGroup');
    // Contacts
    Route::get('/members/', 'ContactsController@index')->name('contacts');
    Route::get('/members/update/{id?}', 'ContactsController@indexUpdate')->name('membersUpdate');
    // Route::get('/members/add', 'ContactsController@indexAdd')->name('contactsAdd');
    Route::post('/members/store', 'ContactsController@store')->name('contactsStore');
    Route::post('/members/search', 'ContactsController@search')->name('contactsSearch');
    // Route::get('/members/{id}/edit', 'ContactsController@edit')->name('contactsEdit');
    ...
    Route::post('/categories/{id}/updateGroup', 'categoriesController@updateGroup')->name('categoriesUpdateGroup');
    Route::get('/categories/destroyGroup/{id}', 'categoriesController@destroyGroup')->name('categoriesDestroyGroup');
    // Categories
    Route::get('/categories/', 'categoriesController@index')->name('categories');
