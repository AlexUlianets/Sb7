...
class ContactsController extends Controller
{
    ...
    public function index()
    {
        ...
        $Contacts = Contact::where('created_by', '=', Auth::user()->id)->orderby('id', 'desc')->paginate(env('BACKEND_PAGINATION'));
        //     }
        // } else {
        //     if ($group_id > 0) {
        //         //List of group contacts
    ...
    public function indexUpdate($group_id = null)
    {
        ...
        // return view("backEnd.contactsAdd", compact("Contacts", "GeneralWebmasterSections", "ContactsGroups", "Countries", "WaitContactsCount", "BlockedContactsCount", "AllContactsCount", "group_id", "search_word"));

        $ContactToEdit = Contact::find($group_id);
        // dd($ContactToEdit);
        if (!empty($ContactToEdit)) {
            // dd($ContactToEdit);
            return view("backEnd.contactsAdd", compact("Contacts", "group_id", "ContactsGroups", "Countries", "GeneralWebmasterSections", "ContactToEdit"));
            // redirect()->action('ContactsController@index', $ContactToEdit->id)->with('ContactToEdit', $ContactToEdit);
        } else {
            return view("backEnd.contactsAdd", compact("Contacts", "group_id", "ContactsGroups", "Countries", "GeneralWebmasterSections", "ContactToEdit"));
        }
    }
    ...
    public function indexEdit($group_id = null)
    {
        ...
        return view("backEnd.contactsAdd",
            compact("Contacts", "GeneralWebmasterSections", "ContactsGroups", "Countries", "WaitContactsCount",
    ...
    public function edit($id)
    {
        ...
        if (!empty($ContactToEdit)) {
            return redirect()->action('ContactsController@indexUpdate', $ContactToEdit->group_id)->with('ContactToEdit',
                $ContactToEdit);
        } else {
            return redirect()->action('ContactsController@index');
        }
